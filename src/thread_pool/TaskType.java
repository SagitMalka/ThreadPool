...
public enum TaskType{
        COMPUTATIONAL(1){
            ...
            public String toString(){
                return "Computational thread_pool.Task";
            }
        },
        IO(2){
            @Override
            public String toString(){return "IO-Bound thread_pool.Task";}
        },
        OTHER(3){
            @Override
            public String toString(){
                return "Unknown thread_pool.Task";
            }
        };
        ...
        public void setPriority(int priority){
            if(validatePriority(priority)) this.typePriority = priority;
                ...
                throw new IllegalArgumentException("riority is not an integer");
                        ;}
